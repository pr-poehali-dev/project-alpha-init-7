      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h2 className="font-orbitron text-2xl font-bold text-white mb-4">
              <span className="text-red-500">S</span>ATOR
            </h2>
            <p className="font-space-mono text-gray-300 mb-6 max-w-md">
              Магический квадрат, переживший тысячелетия. Тайна, которую человечество не может разгадать до сих пор.
            </p>
          ...
          {/* Explore */}
          <div>
            <h3 className="font-orbitron text-white font-semibold mb-4">Исследовать</h3>
        ...
        <div className="mt-8 pt-8 border-t border-red-500/20">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="font-space-mono text-gray-400 text-sm">© 2025 SATOR. Все права защищены.</p>
